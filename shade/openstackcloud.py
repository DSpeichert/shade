...
class OpenStackCloud(
    ...
    def list_servers(self, detailed=False, all_projects=False, bare=False, params=None):
        ...
        :param params: Additional filtering parameters passed to the server.
    ...
    def _list_servers(self, detailed=False, all_projects=False, bare=False, params=None):
